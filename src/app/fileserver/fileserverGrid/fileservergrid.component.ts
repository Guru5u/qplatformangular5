...
@Component({
    ...
    selector: 'file-server-grid',
    providers: [],
    templateUrl: './fileservergrid.component.html',
    styleUrls: ['fileservergrid.component.css']
})


export class FileServerGridComponent implements OnInit {

  private columnDefs;

  constructor(protected httpClient: HttpClient, ) {
    this.columnDefs = [
      {headerName: 'File Server Name', field: 'clusterName', width: 250},
      {headerName: 'Host Name', field: 'version', width: 250 },
      {headerName: 'Protocol', field: 'url', width: 250},
      {headerName: 'Port', field: 'master', width: 250},
