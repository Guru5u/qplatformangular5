...
@Component({
    ...
    selector: 'rdbms-grid',
    providers: [],
    templateUrl: './rdbmsgrid.component.html',
    styleUrls: ['rdbmsgrid.component.css']
})


export class RdbmsGridComponent implements OnInit {

  private columnDefs;

  constructor(protected httpClient: HttpClient, ) {
    this.columnDefs = [
      {headerName: 'DataBase Profile', field: 'clusterName', width: 250},
      {headerName: 'RDBMS', field: 'version', width: 250 },
